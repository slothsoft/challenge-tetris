...
public class StonePositionerUtilTest {
	...
	public void testCalculateFutureY() {
		...
		board.setBlock(3, 15, new SingleColorBlock(Color.BLUE));
	...
	public void testFutureLinesVanished() {
		...
		for (int x = 1; x < blocks.length; x++) {
			if (x > 1) {
				board.setBlock(x, 7, new SingleColorBlock(Color.BLUE));
			}
			board.setBlock(x, 8, new SingleColorBlock(Color.BLUE));
		}
	...
	public void testHoleCount() {
		...
		board.setBlock(0, Board.HEIGHT_IN_BLOCKS - 1, new SingleColorBlock(Color.WHITE));
		board.setBlock(1, Board.HEIGHT_IN_BLOCKS - 1, new SingleColorBlock(Color.WHITE));
