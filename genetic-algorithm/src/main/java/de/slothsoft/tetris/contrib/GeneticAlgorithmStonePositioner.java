...
public class GeneticAlgorithmStonePositioner extends AbstractStonePositioner implements PositionBasedStonePositioner {
	...
	public GeneticAlgorithmStonePositioner() {
		this(Weight.load());
	}
	
	public GeneticAlgorithmStonePositioner(Weight weight) {
		this.weight = weight;
	}
	...
	protected int calculateScore(Stone stone, int blockX, int blockY) {
		...
		score += weight.heightDifferences * getPointsForHeightDifferences(newBoard);
		score += weight.holeCount * StonePositionerUtil.getHoleCount(newBoard.getBlocks(), stone, blockX, blockY);
		score += weight.futureLinesVanished * StonePositionerUtil.getFutureLinesVanished(newBoard, stone, blockY);
		score += weight.pointsForX * getPointsForX(stone, blockX);
		score += weight.pointsForY * getPointsForY(blockY);
		score += weight.pointsForFlatObjects *getPointsForFlatObjects(stone);
	...
	protected void printScore(Stone stone, int blockX, int blockY) {
		...
		System.out.println("getPointsForHeightDifferences = " + weight.heightDifferences * getPointsForHeightDifferences(newBoard));
		System.out.println(
				"getHoleCount = " + weight.holeCount * StonePositionerUtil.getHoleCount(newBoard.getBlocks(), stone, blockX, blockY));
		System.out.println(
				"getFutureLinesVanished = " + weight.futureLinesVanished * StonePositionerUtil.getFutureLinesVanished(newBoard, stone, blockY));
		System.out.println("getPointsForX = " + weight.pointsForX * getPointsForX(stone, blockX));
		System.out.println("getPointsForY = " + weight.pointsForY * getPointsForY(blockY));
		System.out.println("getPointsForFlatObjects = " + weight.pointsForFlatObjects + getPointsForFlatObjects(stone));
	...
	public GeneticAlgorithmStonePositioner wantsPoleOnTheRight(boolean newWantsPoleOnTheRight) {
